  ...
  <div class="container pt-4">
    <div class="row">
      <div class="col-8">
          ...
          <b-button class="btn" variant="dark" v-if="(address === null)"  @click="connectWallet" >Connect your wallet</b-button>
          <b-button class="btn" variant="dark" v-else-if="(address !== null)"  @click="this.goToChooseNFT" >Browse your wallet</b-button>
